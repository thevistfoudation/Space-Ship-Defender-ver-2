...
public class MenuController : MonoBehaviour
{
   ...
   // public ButtonController Btn1, Btn2, Btn3, Btn4, Btn5, Btn6;
    public ButtonController LV1, LV2, LV3, LV4, LV5, LV6, LV7, LV8, LV9, LV10, LV11, LV12,LV13;
    ...
    void Start()
    {
        ...
        LV2.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game2);
        });
       
        LV3.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game3);
        });
        LV4.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game4);
        });
        LV5.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game5);
        });
        LV6.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game6);
        });
        LV7.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game7);
        });
        LV8.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game8);

        });
        LV9.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game9);
        });
        LV10.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game10);
        });
        LV11.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game11);
        });
        LV12.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game12);
        });
        LV13.OnClick((ButtonController btn) => {
            SceneController.OpenScene(AllSceneName.Game13);
        });
    }
